...
# -----------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='PyTorch video prediction model - SAC_LSTM')
...
parser.add_argument('--save_dir', type=str, default='checkpoints/cikm_SAC_LSTM')
parser.add_argument('--gen_frm_dir', type=str, default='/data/data-home/shelei/self_data/gen_frame/PredRNN_pp/cikm_SAC_LSTM/')
